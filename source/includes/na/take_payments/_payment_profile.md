...
Before processing a transaction using a 'Payment Profile', you need to have created a one. See [here](/docs/references/payments_SDKs/save_customer_data).

A multi-use payment profile token is distinct from a single-use card token. See [here](/docs/references/payments_SDKs/save_customer_data).
